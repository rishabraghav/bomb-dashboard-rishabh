            ...
            <div className="boardroomStatsAndFunctions">
                ...
                <div className="boardroomFunctions">
                    <div>
                        ...
                        <button className="button boardroomWithdraw" >Withdraw <img style={{height:"20px", width:"20px", backgroundColor:"#6C9BCF", marginLeft:"3px"}} alt="img" src="https://img.icons8.com/?size=512&id=102673&format=png"/></button>
