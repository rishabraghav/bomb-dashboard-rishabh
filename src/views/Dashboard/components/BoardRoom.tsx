        ...
        <div className="BoardRoom marginForAll">
            <div style={{display: "flex", flexDirection: "row", alignItems:"center"}} >
                ...
                <div className="boardroomHeadings" style={{width:"550px"}}>
                    ...
                    <div style={{display: "flex", justifyContent:"space-between", flexDirection:"row"}}>
                        ...
                        <p style={{color:"white"}}>TVL: ${123}</p>
                    </div>
                </div>
            </div>
            <hr />
            <div style={{width:"600px", padding: "0 2px 0 2px", margin:"0 2px 0 2px"}}><p style={{float: "right", color:"white", padding:"1px", margin:"1px", fontSize:"15px"}}>Total Staked: {getDisplayBalance(totalStakedOnBoardroom)} </p></div>
            <div className="boardroomStatsAndFunctions">
                ...
                <div className="boardroomFunctions">
                    ...
                    <button className="button boardroomClaim" onClick={onReward}>Claim</button>
                </div>
